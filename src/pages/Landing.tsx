        ...
        <div className="max-w-5xl mx-auto text-center animate-fade-in">
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            <div className="flex gap-4">
              <Link to="/app">
                <Button size="lg" className="px-8 py-6 text-lg font-medium bg-primary hover:bg-primary/90 transition-colors">
                  Launch App
                  <ArrowRight className="ml-2 h-5 w-5" />
                </Button>
              </Link>
              <Button size="lg" variant="outline" className="px-8 py-6 text-lg font-medium hover:bg-primary/10 transition-colors">
                Learn More
              </Button>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-14">
            <div className="p-8 rounded-2xl bg-card/50 backdrop-blur-sm border border-border/50 hover:border-primary/50 hover:-translate-y-1 transition-all duration-300">
              <div className="bg-primary/10 p-4 rounded-xl w-fit mb-4">
                <Shield className="h-8 w-8 text-primary" />
              </div>
              <h3 className="text-xl font-semibold mb-3">True Anonymity</h3>
              <p className="text-muted-foreground">Your identity stays protected with wallet-based authentication. No personal data, no tracking.</p>
            </div>
            ...
            <div className="p-8 rounded-2xl bg-card/50 backdrop-blur-sm border border-border/50 hover:border-primary/50 hover:-translate-y-1 transition-all duration-300">
              ...
              <p className="text-muted-foreground">Join a global network of blockchain enthusiasts sharing knowledge and insights.</p>
            </div>
            ...
            <div className="p-8 rounded-2xl bg-card/50 backdrop-blur-sm border border-border/50 hover:border-primary/50 hover:-translate-y-1 transition-all duration-300">
              ...
              <h3 className="text-xl font-semibold mb-3">On-Chain Security</h3>
              <p className="text-muted-foreground">Every interaction is secured on the blockchain, ensuring transparency and immutability.</p>
            </div>
          </div>
